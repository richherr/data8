...
1. Get your copy of this repository:
   ...
   ```
   git clone https://github.com/data-8
   ```
2. Change the file you wish and commit it to the repository.
3. Push your change back to the `data-8` repository (ideally via a pull request).
...
* When you make a change to this repository and push it to the `data-8` `main`
